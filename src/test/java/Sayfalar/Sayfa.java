...
public class Sayfa {
    ...
    public void alanaSifreYaz(String sifreId, String emailSifresi){
        driver.findElement(By.id(sifreId)).sendKeys(emailSifresi);
    }
    ...
    public void klavyeTusuBas(String elementId, Keys klavyeTusu){
